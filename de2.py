...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_evaluat = QtWidgets.QLabel(self.widget_8)
        self.label_evaluat.setMinimumSize(QtCore.QSize(300, 100))
        ...
        self.verticalLayout.addWidget(self.label_evaluat)
